...
exports.paymobWebhook = exports.createPaymentToken = void 0;
...
const upgradeUserTier = async (uid, newTier, daysValid) => {
...
exports.createPaymentToken = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
    ...
    try {
        ...
        const authRes = await (0, node_fetch_1.default)('https://accept.paymob.com/api/auth/tokens', {
            method: 'POST',
        ...
        const orderRes = await (0, node_fetch_1.default)('https://accept.paymob.com/api/ecommerce/orders', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
                auth_token: token,
        ...
        const paymentKeyRes = await (0, node_fetch_1.default)('https://accept.paymob.com/api/acceptance/payment_keys', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
                auth_token: token,
...
exports.paymobWebhook = functions.https.onRequest(async (req, res) => {
    ...
    const { amount_cents, created_at, currency, error_occured, has_parent_transaction, id, integration_id, is_3d_secure, is_auth, is_capture, is_refunded, is_standalone_payment, is_voided, order, owner, pending, source_data, success, } = obj;
    const hmacString = [
        amount_cents,
        created_at,
        currency,
