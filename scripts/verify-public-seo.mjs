...
import {assertNotIndexable404,assertBundleContainsProxyUrl,collectJavaScript} from './production-build-checks.mjs';
...
assertNotIndexable404(readFileSync('dist/404.html','utf8'),readFileSync('dist/index.html','utf8'));
assertBundleContainsProxyUrl(collectJavaScript('dist'),process.env.VITE_AI_PROXY_URL);
