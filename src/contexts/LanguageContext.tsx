...
export const translations = {
  ...
  watch_tooltip: { en: "Add this target to your watchlist. It will be re-checked on every sweep you run.", ar: "أضف هذا الهدف إلى قائمة المراقبة. سيتم إعادة فحصه في كل مسح تقوم بتشغيله.", fr: "Ajoutez cette cible à votre liste de surveillance. Elle sera revérifiée à chaque balayage que vous lancez.", de: "Fügen Sie dieses Ziel Ihrer Beobachtungsliste hinzu. Es wird bei jedem von Ihnen gestarteten Scan erneut geprüft.", es: "Añada este objetivo a su lista de vigilancia. Se volverá a comprobar en cada barrido que ejecute.", tr: "Bu hedefi izleme listenize ekleyin. Çalıştırdığınız her taramada yeniden kontrol edilir.", ru: "Добавьте эту цель в список наблюдения. Она будет проверяться при каждом запущенном вами сканировании." },
  ...
  pricing_f_realtime: { en: "Unlimited On-Demand Sweeps", ar: "مسوحات غير محدودة عند الطلب", fr: "Balayages illimités à la demande", de: "Unbegrenzte On-Demand-Scans", es: "Barridos ilimitados a demanda", tr: "Sınırsız isteğe bağlı tarama", ru: "Неограниченные сканирования по запросу" },
