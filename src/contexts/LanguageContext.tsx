...
export const translations = {
  ...
  landing_features_subtitle: { en: "Explore security checks and public-information tools, each with its own coverage and limitations.", ar: "سبع وحدات متخصصة بتغطي كل نقطة ضعف في بصمتك الرقمية.", fr: "Sept modules spécialisés couvrant chaque vecteur d'attaque.", de: "Sieben spezialisierte Module für jeden Angriffsvektor.", es: "Siete módulos especializados para cada vector de ataque.", tr: "Her saldırı vektörünü kapsayan yedi özel modül.", ru: "Семь специализированных модулей для каждого вектора атак." },
  ...
  landing_final_subtitle: { en: "Use JoeScan to understand available security signals and choose practical next steps.", ar: "انضم لآلاف المستخدمين اللي بيثقوا في جو-سكان لحماية تواجدهم الرقمي.", fr: "Rejoignez des milliers d'utilisateurs qui font confiance à JoeScan.", de: "Schließen Sie sich Tausenden an, die JoeScan vertrauen.", es: "Únete a miles que confían en JoeScan.", tr: "Çevrimiçi varlıklarını korumak için JoeScan'e güvenen binlerce kişiye katılın.", ru: "Присоединяйтесь к тысячам, доверяющим JoeScan." },
  ...
  watch_tooltip: { en: "Add this target to your watchlist for scheduled daily sweeps (IP & domain).", ar: "أضف هذا الهدف إلى قائمة المراقبة للمسوحات اليومية المجدولة (IP والنطاق).", fr: "Ajoutez cette cible à votre liste pour des balayages quotidiens programmés (IP et domaine).", de: "Fügen Sie dieses Ziel für geplante tägliche Scans (IP & Domain) hinzu.", es: "Añada este objetivo para barridos diarios programados (IP y dominio).", tr: "Zamanlanmış günlük taramalar (IP ve alan adı) için bu hedefi listenize ekleyin.", ru: "Добавьте эту цель для ежедневных запланированных сканирований (IP и домен)." },
  ...
  pricing_f_realtime: { en: "Daily Scheduled Sweeps (IP & Domain)", ar: "مسوحات يومية مجدولة (IP والنطاق)", fr: "Balayages quotidiens programmés (IP et domaine)", de: "Täglich geplante Scans (IP & Domain)", es: "Barridos diarios programados (IP y dominio)", tr: "Günlük Zamanlanmış Taramalar (IP ve Alan Adı)", ru: "Ежедневные запланированные сканирования (IP и домен)" },
  ...
  // ─── Referral System V2 ───
  referral_leaderboard: { en: "Referral Leaderboard", ar: "لوحة الصدارة", fr: "Classement des Parrainages", de: "Empfehlungs-Bestenliste", es: "Tabla de Clasificación", tr: "Tavsiye Liderlik Tablosu", ru: "Таблица лидеров" },
  referral_top_inviters: { en: "Top Inviters", ar: "أكثر الداعين", fr: "Meilleurs Inviteurs", de: "Top-Einlader", es: "Principales Invitadores", tr: "En Çok Davet Edenler", ru: "Лучшие приглашающие" },
  referral_no_leaders: { en: "No leaders yet. Be the first!", ar: "لا يوجد متميزين بعد. كُن أنت الأول!", fr: "Pas de leaders pour l'instant. Soyez le premier !", de: "Noch keine Anführer. Sei der Erste!", es: "Aún no hay líderes. ¡Sé el primero!", tr: "Henüz lider yok. İlk siz olun!", ru: "Пока нет лидеров. Станьте первым!" },
  referral_custom_code: { en: "Customize Code", ar: "تخصيص الكود", fr: "Personnaliser le Code", de: "Code Anpassen", es: "Personalizar Código", tr: "Kodu Özelleştir", ru: "Настроить код" },
  referral_code_hint: { en: "Make it memorable! (3-15 chars, letters/numbers only)", ar: "اجعله مميزاً! (3-15 حرف، حروف وأرقام فقط)", fr: "Rendez-le mémorable !", de: "Mach ihn unvergesslich!", es: "¡Hazlo memorable!", tr: "Akılda kalıcı yapın!", ru: "Сделайте его запоминающимся!" },
  referral_code_save: { en: "Save Code", ar: "حفظ الكود", fr: "Sauvegarder le Code", de: "Code Speichern", es: "Guardar Código", tr: "Kodu Kaydet", ru: "Сохранить код" },
  referral_code_taken: { en: "Code already taken. Try another.", ar: "الكود مستخدم مسبقاً. جرب غيره.", fr: "Code déjà pris. Essayez un autre.", de: "Code bereits vergeben. Versuche einen anderen.", es: "El código ya está en uso. Intenta con otro.", tr: "Kod zaten alınmış. Başka bir tane deneyin.", ru: "Код уже занят. Попробуйте другой." },
  referral_code_success: { en: "Code updated successfully!", ar: "تم تحديث الكود بنجاح!", fr: "Code mis à jour avec succès !", de: "Code erfolgreich aktualisiert!", es: "¡Código actualizado con éxito!", tr: "Kod başarıyla güncellendi!", ru: "Код успешно обновлен!" },
  referral_tier_0: { en: "Unlocks at 1 friend", ar: "تفتح عند دعوة 1 صديق", fr: "Débloque à 1 ami", de: "Wird bei 1 Freund freigeschaltet", es: "Se desbloquea con 1 amigo", tr: "1 arkadaşla açılır", ru: "Разблокируется при 1 друге" },
  referral_tier_1: { en: "Exclusive PDF Security Guide", ar: "دليل أمني حصري PDF", fr: "Guide de sécurité PDF", de: "Exklusiver PDF-Sicherheitsleitfaden", es: "Guía de seguridad PDF", tr: "PDF Güvenlik Kılavuzu", ru: "PDF-руководство по безопасности" },
  referral_tier_3: { en: "1 Week JoeScan Pro Trial", ar: "أسبوع باقة Pro مجاناً", fr: "1 Semaine Pro Offerte", de: "1 Woche Pro-Test", es: "1 Semana de prueba Pro", tr: "1 Hafta Pro Deneme", ru: "1 неделя Pro " },
  referral_tier_5: { en: "1 Month Free Pro", ar: "شهر كامل باقة Pro", fr: "1 Mois Pro Gratuit", de: "1 Monat kostenlos Pro", es: "1 Mes Pro Gratis", tr: "1 Ay Ücretsiz Pro", ru: "1 месяц Pro бесплатно" },
  referral_tier_10: { en: "VIP Supporter Badge", ar: "شارة الشخصيات الهامة (VIP)", fr: "Badge Supporter VIP", de: "VIP-Unterstützer-Abzeichen", es: "Insignia de Seguidor VIP", tr: "VIP Destekçi Rozeti", ru: "Значок VIP-спонсора" }
};
