...
const COMMANDS: CommandItem[] = [
  ...
  { id: 'email', label: 'Email Check', labelAr: 'فحص البريد', icon: Mail, keywords: ['email', 'breach', 'leak', 'البريد'] },
  { id: 'password', label: 'Password Check', labelAr: 'فحص كلمة المرور', icon: KeyRound, keywords: ['password', 'vault', 'strength', 'كلمة المرور'] },
